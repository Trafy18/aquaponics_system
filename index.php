...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-5" style="text-align: center">
      ...
      <div style="display: flex">
        <div class="card text-center">
          <div class="card-header">Suhu Air (°C)</div>
          <div class="card-body">
        ...
        <div class="card text-center">
          <div class="card-header">Ketinggian Air (cm)</div>
          <div class="card-body">
    ...
    <div class="container border">
      <div class="row">
        <div class="col-12">
          <div class="card-mb-4 mt-2 border-0 text-center" style="border-radius:10px;">
          <h3>Data Table Monitoring Akuaponik</h3>
            <div class="card-body">
              <div class="table-responsive p-4">
                <table class="table table-striped table-border align-items-center mb-0" id="myTable">
    ...
    <script>
      $(document).ready(function () {
        ...
        // Ambil data dari PHP
      $.ajax({
      url: 'getSensorData.php', // Endpoint PHP
      method: 'GET',
      success: function(response) {
        ...
        // Membuat Chart
        const suhuCtx = document.getElementById('chartDataSuhu').getContext('2d');
        new Chart(suhuCtx, {
      ...
      const phCtx = document.getElementById('chartDataph').getContext('2d');
      new Chart(phCtx, {
        type: 'line',
        data: {
          labels: labels,
      ...
      const tdsCtx = document.getElementById('chartDataTds').getContext('2d');
      new Chart(tdsCtx, {
        type: 'line',
        data: {
          labels: labels,
      ...
      const ketinggianCtx = document.getElementById('chartDataKetinggian').getContext('2d');
